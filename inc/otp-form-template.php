...
<div class="wrap orion-otp-mega-wrapper">
		...
		<div class="media text-muted pt-3">
			<div class="d-sm-flex media-body ihs-input-wrap pb-3 mb-0 small lh-125 border-bottom border-gray">
				<ul>
					...
					<!--Free version-->
					<li class=""><?php echo __( 'If you are using MSG91, the free version of the plugin uses ', $text_domain ); ?><strong><?php echo __( 'OTP route', $text_domain ); ?></strong>. <?php echo __( 'So you need to buy OTP credits from MSG91 plugin. If you would like to use it with Transactional credit or if you want to have Mobile OTP verification on Woo-commerce checkout page, and send custom Order SMS ( e.g. on Order Complete, Cancelled etc ), then you would need to buy the premium version', $text_domain ); ?>
					</li>
					<!--Upgrade to Pro Link-->
					<li class="">
						<?php $link_text = __( 'Upgrade to Pro', $text_domain ); ?>
		...
		<div class="media text-muted pt-3">
			<div class="d-sm-flex media-body ihs-input-wrap pb-3 mb-0 small lh-125 border-bottom border-gray">
				<ul>
					...
					<li><?php echo __( 'Based on the queries I have been dealing with and solving them in the past, I have observed that the theme or plugins that you are using may add some styles or scripts that may interfere with the default functionality of Orion OTP Plugin.', $text_domain ) ?></li>
					<br>
					...
					<li>
						...
						<?php echo __( ', troubleshooting steps and it still does not work, it means we would have to do customization to make the plugin work with your theme/plugin. For any queries you can write to us on: ', $text_domain ); ?>
	...
	<div class="my-3 p-3 bg-white rounded box-shadow ihs-api-config-cont">
		<p class="border-bottom border-gray pb-2 mb-0"><?php echo __( 'You can get the required Key from MSG91/Twilio.', $text_domain ); ?></p>
		<!--Api Type-->
		<div class="media text-muted pt-3">
